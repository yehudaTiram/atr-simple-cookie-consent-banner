...
class ATR_Simple_Cookie_Consent_Banner_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . '../admin/css/atr-simple-cookie-consent-banner-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . '../admin/js/atr-simple-cookie-consent-banner-admin.js', array( 'jquery' ), $this->version, false );
